...
Puoi anche associare le credenziali del sito di supporto NetApp all'account BlueXP di cui sei membro. Le credenziali a livello di account NSS consentono di implementare Cloud Volumes ONTAP quando si porta la propria licenza (BYOL), registrare i sistemi PAYGO e aggiornare il software Cloud Volumes ONTAP.
