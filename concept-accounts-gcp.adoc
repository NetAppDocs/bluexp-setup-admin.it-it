...
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-deploying-gcp.html["Scopri come implementare Cloud Volumes ONTAP in Google Cloud e seleziona un progetto"^]
