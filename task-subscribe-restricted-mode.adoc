...
---
= Sottoscrizione ai servizi dati BlueXP  (modalità limitata)
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Un abbonamento al mercato consente di addebitare i seguenti servizi dati BlueXP  con modalità limitata:
