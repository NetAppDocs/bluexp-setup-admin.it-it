...
=== Requisito IMDSv1 per EC2 istanze

Devi essere consapevole che la versione 1 (IMDSv1) del servizio metadati istanza è necessaria sulle istanze Amazon EC2 prima di installare manualmente il software del connettore in AWS.

https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["Scopri di più sul requisito per IMDSv1 in AWS"].
