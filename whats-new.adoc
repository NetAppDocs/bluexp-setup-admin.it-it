...
image:screenshot-edit-name.png["Schermata che mostra la possibilità di modificare il nome in Impostazioni utente."]
...
=== Requisiti del servizio metadati istanza Amazon EC2

Devi essere consapevole del fatto che IMDSv1 è necessario su istanze EC2 prima di installare manualmente il software del connettore in AWS.

link:reference-limitations.html["Scopri di più sul requisito per IMDSv1 in AWS"].
