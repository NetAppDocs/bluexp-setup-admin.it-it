...
==== Aggiornamento delle autorizzazioni di Azure

Abbiamo aggiornato la policy del connettore per Azure in modo da includere le seguenti autorizzazioni:
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html["Ulteriori informazioni sul supporto Cloud Volumes ONTAP per i set di scalabilità delle macchine virtuali"^]
...
=== requisiti aggiornati del motore Docker
...
==== aggiornamento dei permessi AWS
...
=== richiede di aggiornare le credenziali NSS
...
=== punti finali ridotti per il connettore
...
=== aggiornamento richiesto per gli account del sito di supporto NetApp
...
=== Modifica account NSS per Cloud Volumes ONTAP
...
=== autenticazione con identità di servizio
...
=== Gestione account NSS dal pannello di supporto
...
=== l'API chiama direttamente Cloud Manager
...
==== miglioramento disponibile in tutti i cloud provider
...
==== miglioramento disponibile in Azure
...
=== miglioramenti al Cloud Tiering
...
==== miglioramenti del Support Dashboard
