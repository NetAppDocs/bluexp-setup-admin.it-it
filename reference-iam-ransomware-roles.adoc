...
[role="lead"]
I ruoli ransomware sono progettati per fornire accesso al servizio di protezione dal ransomware. Agli utenti può essere assegnato un ruolo amministrativo che consente loro di intervenire nella protezione dal ransomware o un ruolo di spettatore se si limitano a svolgere responsabilità di monitoraggio. I due ruoli sono: Amministratore di protezione ransomware e visualizzatore di protezione ransomware. La differenza principale tra i due ruoli consiste nelle azioni che possono intraprendere nella protezione ransomware.
