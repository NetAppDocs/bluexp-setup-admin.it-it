...
Il connettore contatta i seguenti endpoint per implementare e gestire Cloud Volumes ONTAP nel tuo ambiente di cloud pubblico.
...
Se l'organizzazione richiede la distribuzione di un server proxy per il traffico Internet in uscita, ottenere le seguenti informazioni sul proxy HTTP o HTTPS:
