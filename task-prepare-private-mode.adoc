...
Endpoint per le operazioni quotidiane:: Il connettore contatta i seguenti endpoint per gestire risorse e processi all'interno del tuo ambiente di cloud pubblico.
+
--
[cols="2a,1a"]
|===
