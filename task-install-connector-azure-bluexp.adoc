...
[role="lead"]
Puoi creare un connettore in Azure direttamente da BlueXP . Per creare un connettore in Azure da BlueXP , è necessario configurare la rete, preparare un ruolo Azure da utilizzare per distribuire il connettore, quindi implementare il connettore.
