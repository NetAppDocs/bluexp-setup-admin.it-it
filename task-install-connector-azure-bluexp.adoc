...
Creare un ruolo personalizzato Azure che è possibile assegnare all'account Azure o a un'entità di servizio Azure ad. BlueXP esegue l'autenticazione con Azure e utilizza queste autorizzazioni per creare l'istanza di Connector per conto dell'utente.
