...
.Fasi
. Se si sta creando il primo ambiente di lavoro, selezionare *Aggiungi ambiente di lavoro* e seguire le istruzioni. In caso contrario, selezionare l'elenco a discesa *Connector* (connettore) e selezionare *Add Connector* (Aggiungi connettore).
+
