...
BlueXP seleziona queste credenziali AWS per impostazione predefinita quando si crea un nuovo ambiente di lavoro per Cloud Volumes ONTAP:
...
link:task-adding-aws-accounts.html#add-credentials-to-a-connector["Scopri come aggiungere le credenziali AWS a un connettore esistente."]
...
* link:task-adding-aws-accounts.html#add-credentials-to-a-connector["Scopri come aggiungere le credenziali AWS a BlueXP per la creazione di un connettore"]
