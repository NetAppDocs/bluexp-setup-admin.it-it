...
* link:task-set-up-permissions-azure.html["Impostazione delle autorizzazioni per l'installazione del connettore in Azure (modalità standard)"]
...
Il connettore effettua le seguenti richieste API per gestire gli ambienti di lavoro Azure NetApp Files:
