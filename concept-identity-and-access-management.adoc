...
Quando ti registri, BlueXP ti chiede di creare una nuova organizzazione.
...
Associare una risorsa a una cartella non la rende automaticamente accessibile a tutti i progetti nella cartella. L'amministratore della cartella o del progetto decide quali progetti possono accedere alla risorsa. Dopo aver preso questa decisione, l'amministratore può quindi associare la risorsa ai progetti giusti.
...
Organizzazione:: Quando si concede a un membro un ruolo di accesso a livello di organizzazione, tutte le cartelle, i progetti e le risorse dell'organizzazione ereditano tali ruoli. Ciò significa che il membro dispone delle autorizzazioni per tutto ciò che riguarda l'organizzazione.
...
Potresti rendere disponibile un connettore per un altro progetto nei seguenti casi:
