...
Le cartelle possono contenere progetti, altre cartelle o entrambi.
...
Quando si associa una risorsa a una cartella, questa non diventa automaticamente accessibile a tutti i progetti: solo l'amministratore della cartella o del progetto può visualizzarla. L'amministratore della cartella o del progetto decide quali progetti possono accedervi e associa la risorsa ai progetti appropriati.
