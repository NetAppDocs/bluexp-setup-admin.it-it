...
| link:reference-iam-storage-roles.html["Amministratore dello storage"] | Gestire le funzioni di governance e di integrità dello storage, individuare le risorse di storage e modificare e rimuovere gli ambienti di lavoro esistenti. 
