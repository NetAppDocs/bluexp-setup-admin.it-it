...
Quando ti federa con il sito di supporto NetApp , gli utenti possono accedere a BlueXP con le stesse credenziali che usi per il sito di supporto NetApp , Active IQ e altre app associate al tuo account del sito di supporto NetApp . Dopo aver configurato la federazione, anche tutti i nuovi utenti che creano un account per il sito di supporto NetApp potranno accedere a BlueXP.
...
NetApp supporta i seguenti provider di identità e protocolli per la federazione:
