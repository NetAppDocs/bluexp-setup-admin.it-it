...
+
https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html["Scopri di più sulle opzioni di rilevamento e gestione dei cluster ONTAP on-premise"^]
...
* Caching edge
* Rilevamento di Google Cloud Storage
* Cluster Kubernetes
...
. Impostare https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-storage-management.html["Modalità di gestione della capacità"^]
+
