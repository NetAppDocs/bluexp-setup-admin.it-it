...
Puoi iniziare a utilizzare BlueXP  per gestire in modo centralizzato le risorse di storage senza installare un connettore se il sistema è in esecuzione in modalità standard.
