...
Non supportato in Google Cloud o in https://aws.amazon.com/federal/us-intelligence-community/["AWS C2S/SC2S"^] oppure https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure IL6"^] 
...
.16+| *Servizi* | Backup e recovery | Sì | Sì 
...
| Caching dei volumi | No | No .5+| *Caratteristiche* 
