...
| Backup e recovery  a| 
* È supportato il backup e il ripristino di volumi ONTAP on-premise su sistemi StorageGRID.
+
...
* È supportato anche il backup e il ripristino di volumi ONTAP on-premise in ONTAP S3.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-to-ontap-s3.html["Ecco come eseguire il backup dei dati ONTAP on-premise su ONTAP S3"^]
