...
[role="lead"]
BlueXP offre _modalità di distribuzione_ che ti consentono di soddisfare i tuoi requisiti aziendali e di sicurezza.  La _modalità standard_ sfrutta un livello di software come servizio (SaaS) per fornire funzionalità complete, mentre la _modalità limitata_ e la _modalità privata_ sono disponibili per le organizzazioni che hanno restrizioni di connettività.
...
| Backup e recovery | Supportato nelle regioni governative e commerciali con modalità limitata. Non supportato nelle regioni sovrane con modalità limitata. In modalità limitata, il BlueXP backup and recovery supportano solo il backup e il ripristino dei dati del volume ONTAP . https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivity["Consente di visualizzare l'elenco delle destinazioni di backup supportate per i dati ONTAP"^] In modalità limitata, il BlueXP backup and recovery supportano solo il backup e il ripristino dei dati del volume ONTAP . https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivity["Consente di visualizzare l'elenco delle destinazioni di backup supportate per i dati ONTAP"^] Il backup e il ripristino dei dati delle applicazioni e dei dati delle macchine virtuali non sono supportati. 
...
| Backup e recovery | Supportato nelle regioni commerciali AWS e Azure. Non supportato in Google Cloud o in https://aws.amazon.com/federal/secret-cloud/["Cloud segreto AWS"^] , https://aws.amazon.com/federal/top-secret-cloud/["Cloud AWS top secret"^] , O https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure IL6"^] In modalità privata, il BlueXP backup and recovery supportano solo il backup e il ripristino dei dati del volume ONTAP . https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Consente di visualizzare l'elenco delle destinazioni di backup supportate per i dati ONTAP"^] Il backup e il ripristino dei dati delle applicazioni e dei dati delle macchine virtuali non sono supportati. 
...
| Backup e recovery  a| 
In modalità privata, il BlueXP backup and recovery supportano solo il backup e il ripristino dei dati del volume ONTAP . https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Visualizza l'elenco delle destinazioni di backup supportate per i dati dei volumi ONTAP"^]
...
.16+| *Servizi* | Avvisi | No | No 


| Backup e recovery | SÌhttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivityView[] l'elenco delle destinazioni di backup supportate per i dati del volume ONTAP ^] | SÌhttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Visualizza l'elenco delle destinazioni di backup supportate per i dati dei volumi ONTAP"^] 
...
.6+| *Caratteristiche* | Gestione delle identità e degli accessi BlueXP  | Sì 
